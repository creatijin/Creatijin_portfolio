      ...
      projectlist: [
        {
          ...
          bg: pl_01 ,
          txt: '신세계 인터코스 페이지는 XE를 기반으로 제작되었으며 클라이언트의 요구에 따라서 풀 페이지로 상하 슬라이드 방식으로 제작 되었습니다. '
        },
        {
          company: 'SPAAAADE',
          name: '휠리펀트',
        ...
        },
        {
          ...
          bg: pl_13 ,
          txt: 'XELF는 웹 PPT 템플릿 제작 툴로써 그로비스인포텍과 함께 제작 개발하여 1~3차까지 웹 페이지를 제작했습니다. 타 사이트와 다르게 하드코딩으로 작업되었으며, 앞으로 발전할 플렉서블 디스플레이(Flexible Display)의 기기에 대응하기 위해 리사이징에 대비하여 만들어졌습니다.'
        },
        {
          company: 'SPAAAADE',
          name: 'Dr.bom',
